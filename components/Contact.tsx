      ...
      <div className="container mx-auto px-6 max-w-3xl">
        <div className="bg-surface border border-white/10 p-1">
          ...
          <div className="p-8 md:p-12 bg-black/50">
            <h2 className="text-2xl font-bold text-white mb-2 uppercase">{t.contact.title}</h2>
            <p className="text-dim text-sm font-mono mb-8">{t.contact.subtitle}</p>

            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-1">
                <label className="text-xs text-primary font-mono uppercase">{t.contact.label_name}</label>
              ...
              <div className="space-y-1">
                <label className="text-xs text-primary font-mono uppercase">{t.contact.label_email}</label>
              ...
              <div className="space-y-1">
                <label className="text-xs text-primary font-mono uppercase">{t.contact.label_message}</label>
